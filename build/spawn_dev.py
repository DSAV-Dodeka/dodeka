...
def spawn_dev():
    ...
    spawn_write('./config.toml', './kv/deploy', target_dir="../dev/deploykv", join_target=False,
                source_env='default.kv')
    spawn_write('./config.toml', './db/deploy', target_dir="../dev/deploydb", join_target=False,
