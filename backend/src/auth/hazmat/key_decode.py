...
def aes_from_symmetric(symmetric_key: str) -> SymmetricKey:
    """Symmetric_key is a base64url encoded AES-GCM key (which should be raw, randomly-generated bytes, of
    256-bit length).

    Raises:
        ValueError: if the key cannot be decoded or is not the correct length.
    """
